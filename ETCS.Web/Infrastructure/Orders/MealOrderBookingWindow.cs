...
public sealed class MealOrderBookingWindow
{
    ...
    public MealOrderBookingWindow(IOptions<WebOptions> options)
    {
        var configured = options.Value.MealOrderCutoffHour;
        _cutoffHour = configured is >= 0 and <= 23 ? configured : DefaultCutoffHour;
    }
