...
USING (
    VALUES
        ...
        (N'BlacklistCard',               N'Blacklist Cards',            N'Master',    N'BlacklistCard',     N'Index',                45),
        ...
        (N'Category',                    N'Menu Type/Category',         N'Inventory', N'Category',          N'Index',                70),
        (N'MealType',                    N'Meal Type',                  N'Inventory', N'MealType',          N'Index',                75),
        ...
        (N'SchoolCalendar',              N'School Calendar',            N'Inventory', N'SchoolCalendar',    N'Index',                115),
        ...
        (N'Report.TerminalSalesSummary', N'Sales Summary',              N'Reports',   N'Report',            N'TerminalSalesSummary', 140),
        (N'Report.MealOrdersMealDb',     N'Meal Order Report (NEW)',    N'Reports',   N'Report',            N'MealOrdersMealDb',     150),
        (N'Report.MealOrderPaymentsMealDb', N'Meal Order Payment Report (NEW)', N'Reports', N'Report',     N'MealOrderPaymentsMealDb', 155),
        (N'Report.MealOrders',           N'Meal Order Report (OLD)',    N'Reports',   N'Report',            N'MealOrders',           160),
        (N'Report.MealOrderPayments',    N'Meal Order Payment Report (OLD)', N'Reports', N'Report',        N'MealOrderPayments',    165),
